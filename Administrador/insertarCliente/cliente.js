...
function direccionCliente() {
    ...
    if (d == "") {
        ...
        $('#errorDireccion').addClass('alert alert-danger');
        $('#errorDireccion').html("Error! Debes rellenar este campo");
    } else {
        array["direccion"] = true;
        $('#errorDireccion').removeClass('alert alert-danger');
        $('#errorDireccion').addClass('alert alert-success');
        $('#errorDireccion').html("Campo valido!");
    }
    comprobarboton();
}
